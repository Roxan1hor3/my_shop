...
urlpatterns = [
    ...
    path('wishlist_append/<int:product_id>/<int:wish_list_id>', AddProductToWishList.as_view(), name='wishlist_append'),
    path('wishlist_remove/<int:product_id>/<int:wish_list_id>', RemoveProductFromWishList.as_view(), name='wishlist_remove'),

    path('cart/<int:pk>/', CartView.as_view(), name='cart'),
    path('cart_append/<int:product_id>/<int:cart_id>', AddProductToCart.as_view(), name='cart_append'),
    path('cart_remove/<int:product_id>/<int:cart_id>', RemoveProductFromCart.as_view(), name='cart_remove'),

    path('cart/quality_cart/<int:cart_id>', ChangeQuality.as_view(), name='quality_cart'),
